...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/table/yield-table'),
        name: 'YieldTable',
        meta: { title: '生产流水', icon: 'el-icon-s-open', affix: false, noCache: false }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/table/wages-table'),
        name: 'WagesTable',
        meta: { title: '工资报表', icon: 'money', affix: false, noCache: false }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'OrderTable',
        meta: { title: '订单管理', icon: 'el-icon-s-management', affix: false, noCache: false }
      }
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/pattern/break'),
        name: 'break',
        meta: { title: '断线热力图', icon: 'el-icon-warning', affix: false, noCache: false }
      }
    ]
  },
  {
